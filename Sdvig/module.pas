...
uses crt, windows, strings;
  ...
  procedure outdecimal(numb8: shortint; numb16: integer; numb32: longint; sign: boolean; col: integer);
  ...
  procedure CONVERT(numb8: shortint; var numb8u: byte; numb16: integer;var numb16u: word; numb32: longint;var numb32_1, numb32_2: longint);
  stdcall;
  external name '_CONVERT@0';
  {$L a.obj}

implementation

  procedure outdecimal(numb8: shortint; numb16: integer; numb32: longint; sign: boolean; col: integer);
  var  numb32_1, numb32_2: longint;
       numb16u: word;
       numb8u: byte;
  begin
    if not sign then begin
        CONVERT(numb8, numb8u, numb16, numb16u, numb32, numb32_1, numb32_2);
        case col of
           8:  write(numb8u);
           16: write(numb16u);
           32: begin
  ...
  begin
    ...
    window(17, 7, 50, 9);
    print('Сменить режим демонстрации числа');
    writeln;
    print('знаковый/беззнаковый ');
